...
CREATE TABLE IF NOT EXISTS `email_list` (
  ...
  `job_function_uri` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `footer_link` (
  ...
  `perma_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'If(position == 5 ){Permalink will-> Level}else{Pernalink}',
...
CREATE TABLE IF NOT EXISTS `job_function_uri` (
  ...
  `type` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'job-levels',
  ...
  `last_update_date` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `payment_status` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `order_delevery_status` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `type` (
  ...
  `type_desc` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  PRIMARY KEY (`type_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4524256 DEFAULT CHARSET=utf8mb3;
