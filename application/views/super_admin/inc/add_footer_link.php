<div class="page-wrapper">
    <div class="page-content">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <div class="btn-group">
                    <a href="<?php if(isset($address)){echo base_url('super_admin/list_footer_address');}else{echo base_url('super_admin/list_footer_link');}?>" type="button" class="btn btn-primary"><i class="bx bx-plus-circle"></i> <?php if(isset($address)){echo 'Footer Address List';}else{echo 'Footer Link List';}?></a>
                    </div>
                </div>
            </div>
        <!--end breadcrumb-->
                            ...
                            <div class="col-md-6">
								...
								<label class="form-label">
										<?php
											...
											echo 'PermaLink |Already Included';
											echo '<label class="text-danger"> *http://yourdomain.com/home/</label>';
											}
										?>
								</label>
                                    <input type="text" id="perma_link" name="perma_link" class="form-control" placeholder="<?php if (isset($address)){echo 'Level';}else{echo 'Perma_link';}?>">
                                </div>
                            </div>
