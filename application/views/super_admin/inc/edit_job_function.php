                        ...
                        <div class="row border border-1">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="hidden" name="job_function_id" value="<?= $page_data !== null ? $page_data->job_function_id : 'No Data'; ?>">
                                    <input type="text" id="job_function" value="<?= $page_data !== null ? $page_data->job_function : ''; ?>" name="job_function" class="form-control" placeholder="Example: Medical Officer, CEO" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Job Function URI <label class="text-danger"> *</label></label>
                                    <input type="text" class="form-control" placeholder="medical_officer" id="job_function_uri" value="<?= $page_data !== null ? $page_data->job_function_uri : 'No Data'; ?>" name="job_function_uri" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
